      ...
      body: Column(
        ...
        Expanded(child: Padding(
          ...
          child: GridView.count(
            ...
            crossAxisCount: 4,
            children: <Widget> [
              Component1( Text('%',style: TextStyle(fontSize: 30),) , () { },Colors.grey[200]),
              Component1( Text('CE',style: TextStyle(fontSize: 30),) , () { },Colors.grey[200]),
              Component1( Text('C',style: TextStyle(fontSize: 30),) , () { },Colors.grey[200]),
              Component1( Icon(Icons.backspace) , () { },Colors.grey[200]),
              Component1( Text('1/x',style: TextStyle(fontSize: 30),) , () { },Colors.grey[200]),
              Component1( Text('x2',style: TextStyle(fontSize: 30),) , () { },Colors.grey[200]),
              Component1( Text('√',style: TextStyle(fontSize: 30),), () { },Colors.grey[200]),
              Component1( Text('/',style: TextStyle(fontSize: 30),) , () { },Colors.grey[200]),
              ...
              Component1( Text('x',style: TextStyle(fontSize: 30),) , () { },Colors.grey[200]),
              ...
              Component1( Text('-',style: TextStyle(fontSize: 30),) , () { },Colors.grey[200]),
              Component1( Text('1',style: TextStyle(fontSize: 30),) , () { 
                setState(() {
                  if(cal==0){
                    cal= 1;
                  }else{cal= cal + '1';};
